...
- Interactive widget/workspace state wiring
- Real Stage 1 service layer for repo scan, search, docs sync, meeting parsing, and local memory
...
Open the app at the local Jac dev URL.
